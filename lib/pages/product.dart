...
class ProductPage extends StatelessWidget {
  ...
  ProductPage({this.title='Unknown', this.imageUrl='assets/food.jpg', this.description='Nothing yet...', this.price=0.0});
    ...
    child: Scaffold(
      ...
      slivers: <Widget>[
        ...
        SliverAppBar(
          ...
          expandedHeight: 250,
          flexibleSpace: FlexibleSpaceBar( title:Text(this.title) ,background: Image(image: AssetImage('assets/food.jpg'), fit: BoxFit.cover,)),
          actions: <Widget>[
            IconButton(icon: Icon(Icons.delete),onPressed: () =>_showWarningDialogue(context),)
          ],
          floating: true,
        ),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text("\$"+this.price.toString(), style: TextStyle(color: Colors.white),),
                          ),
